...
#define lcd_driver_wrap_target 0
#define lcd_driver_wrap 25

static const uint16_t lcd_driver_program_instructions[] = {
            //     .wrap_target
    0x80a0, //  0: pull   block                      
    0xe000, //  1: set    pins, 0                    
    0xa027, //  2: mov    x, osr                     
    0x0030, //  3: jmp    !x, 16                     
    0x0005, //  4: jmp    5                          
    0xef01, //  5: set    pins, 1                [15]
    0x80a0, //  6: pull   block                      
    0xa0f7, //  7: mov    osr, ::osr                 
    0x6078, //  8: out    null, 24                   
    0xef03, //  9: set    pins, 3                [15]
    0x6304, // 10: out    pins, 4                [3] 
    0xef01, // 11: set    pins, 1                [15]
    0xef03, // 12: set    pins, 3                [15]
    0x6304, // 13: out    pins, 4                [3] 
    0xef00, // 14: set    pins, 0                [15]
    0x0500, // 15: jmp    0                      [5] 
    0x80a0, // 16: pull   block                      
    0xa0f7, // 17: mov    osr, ::osr                 
    0x6078, // 18: out    null, 24                   
    0xef02, // 19: set    pins, 2                [15]
    0x6304, // 20: out    pins, 4                [3] 
    0xef00, // 21: set    pins, 0                [15]
    0xef02, // 22: set    pins, 2                [15]
    0x6304, // 23: out    pins, 4                [3] 
    0xef00, // 24: set    pins, 0                [15]
    0x0500, // 25: jmp    0                      [5] 
            //     .wrap
};

#if !PICO_NO_HARDWARE
static const struct pio_program lcd_driver_program = {
    .instructions = lcd_driver_program_instructions,
    .length = 26,
    .origin = -1,
};

static inline pio_sm_config lcd_driver_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + lcd_driver_wrap_target, offset + lcd_driver_wrap);
    return c;
}
...
#define cdhc_out_register_wrap_target 0
#define cdhc_out_register_wrap 8

static const uint16_t cdhc_out_register_program_instructions[] = {
            //     .wrap_target
    0x2086, //  0: wait   1 gpio, 6                  
    0x80a0, //  1: pull   block                      
    0xe02f, //  2: set    x, 15                      
    0xe000, //  3: set    pins, 0                    
    0x6001, //  4: out    pins, 1                    
...
#if !PICO_NO_HARDWARE
static const struct pio_program cdhc_out_register_program = {
    .instructions = cdhc_out_register_program_instructions,
    .length = 9,
    .origin = -1,
};

static inline pio_sm_config cdhc_out_register_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + cdhc_out_register_wrap_target, offset + cdhc_out_register_wrap);
    return c;
}
